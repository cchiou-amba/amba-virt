...
#   make -C $(EVE_KERNEL) O=$(KDIR_NOHYPER) modules_prepare
#   make -C $(EVE_KERNEL) O=$(KDIR_NOHYPER) M=... modules
#
...
# Userspace for NOHYPER (amba-virt-server). HVM CLI stays native $(CC).
