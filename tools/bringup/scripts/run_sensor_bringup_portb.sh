#!/bin/sh
#
# tools/bringup/scripts/run_sensor_bringup_portb.sh
#
# Unified, deterministic end-to-end sensor bringup and video pipeline test runner for Port B (Link 1 / VIN1).
...
LUA_SCRIPT="${2:-/persist/scripts/n1_655_vin1_1080p_linear.lua}"

echo "================================================================================"
echo " Starting Deterministic Port B Sensor Bringup on: $TARGET"
echo "================================================================================"
...
echo "=== 9. Inserting SerDes & Sensor drivers (Port B / Bridge 1 id=0x08040201 brg_id=0x2) ==="
load_mod "vio_monitor"
load_mod "ambrg"
load_mod "max96712" "id=0x08040201 dts_addr=1 use_max20087=0"
load_mod "os08a10_mipi_brg" "brg_id=0x2"
...
echo "================================================================================"
echo " Port B Bringup script completed on: $TARGET"
echo "================================================================================"
